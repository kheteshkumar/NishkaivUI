...
if (window.location.host.includes("forms.uat")){
  baseUrl = 'https://api.uat.hellopatients.com/';
}
if (window.location.host.includes("forms.hellopatients")) {
...
export class AppSetting {
  ...
  static publicForms = {
    getTokenDetails: baseUrl + 'forms/details',
    submissions: baseUrl + 'publicform/submissions',
    getTransactionStatus: baseUrl + 'publicform/{parentId}/payment/{paymentId}/details'
  };
  ...
  //  add: baseUrl + 'providers/{providerId}/users',
  ...
  //  // getCardDetails: 'https://api.freebinchecker.com/bin/{bin}',
  //  // getCardDetails: 'https://lookup.binlist.net/{bin}',
  ...
  //  checkAvailability: baseUrl + 'providers/{providerId}/doctors/{doctorId}/availability'
  //}
  ...
  //static defaultDueInDaysForInvoice = 30;
